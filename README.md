...
🎓 Pursuing **B.Tech in Artificial Intelligence & Data Science** at VES Institute of Technology

💡 I believe in learning by building — every project is a new problem to solve.

**Currently working on:**
- 🔹 **Java + DSA** — Solving problems daily on LeetCode
- 🔹 **Full Stack Web Dev** — HTML, CSS, JS, React, Supabase
- 🔹 **AI/ML** — Exploring real-world data science applications
- 🔹 **SKillBridge** — My flagship AI career platform 🚀

🎯 **Goal:** Write clean, efficient, and innovative code that transforms ideas into real-world solutions.
...
|---------|-------------|------|------|
| 🚀 **[SKillBridge](https://github.com/user-Rishabh/SKillBridge)** | AI-powered career platform — personalized roadmaps, skill gap analysis, job readiness score | HTML · CSS · JS · React · Supabase | [🌐 Live](https://s-kill-bridge.vercel.app) |
| 🧮 **[Calculator](https://github.com/user-Rishabh/Calculator)** | Basic calculator built in Java | Java | — |
| ☕ **[JAVA-MINI-PROJECT](https://github.com/user-Rishabh/JAVA-MINI-PROJECT)** | Java mini project exploring core concepts | Java | — |
| 📁 **[Repository-demo](https://github.com/user-Rishabh/Repository-demo)** | First Git repo — learning version control | — | — |
...
| Activity | Status |
|----------|--------|
| 🌱 Learning Java concepts | In Progress |
| ⚙️ Solving DSA problems daily on LeetCode | Active |
| 🚀 Building SKillBridge — AI career platform | In Progress |
| 🌍 Exploring real-world problem solving | Always |
...
![Profile Views](https://komarev.com/ghpvc/?username=user-Rishabh&color=a78bfa&style=flat-square&label=Profile+Views)
